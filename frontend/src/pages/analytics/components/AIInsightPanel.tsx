      ...
      <div className="relative flex items-center justify-between px-5 py-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            title="AI Settings"
            className="p-1.5 rounded-lg text-slate-600 hover:text-violet-400 hover:bg-violet-950/40 transition-colors"
          >
            <Settings size={13} />
          </button>
          <button
            ...
            className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg bg-violet-600/80 hover:bg-violet-500 disabled:opacity-40 disabled:cursor-not-allowed text-white transition-colors font-medium"
          >
