...
def read_risk_advisor(
    ...
    strategy_id: int | None = Query(None, description="Strategy ID (single, backward compat)"),
    strategy_ids: list[int] | None = Query(None, description="Strategy IDs for multi-strategy confluence"),
